...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def update_plot_data1(self,data_line,data):
        ...
        if  self.x1[self.idx1] >0.5:
            self.ui.Channel1.setLimits(xMin =min(x , default=0), xMax=max(x, default=0)) #disable paning over xlimits
    ...
    def update_plot_data2(self,data_line,data):
        ...
        if  self.x2[self.idx2] >0.5:
            self.ui.Channel2.setLimits(xMin =min(x , default=0), xMax=max(x, default=0)) #disable paning over xlimits
    ...
    def update_plot_data3(self,data_line,data):
        ...
        if  self.x3[self.idx3] >0.5:
            self.ui.Channel3.setLimits(xMin =min(x , default=0), xMax=max(x, default=0)) #disable paning over xlimits
 ...
 #Zooming in and out 
    def zoomin1 (self):
     center_x=(self.ui.Channel1.plotItem.getAxis("bottom").range[0]+self.ui.Channel1.plotItem.getAxis("bottom").range[1])/2
     center_y=0
     self.ui.Channel1.plotItem.getViewBox().scaleBy(y=0.9 ,x=0.9,center=(center_x,center_y))
    def zoomin2 (self):
     center_x=(self.ui.Channel2.plotItem.getAxis("bottom").range[0]+self.ui.Channel2.plotItem.getAxis("bottom").range[1])/2
     center_y=0
     self.ui.Channel2.plotItem.getViewBox().scaleBy(y=0.9 ,x=0.9,center=(center_x,center_y))
    def zoomin3 (self):
     center_x=(self.ui.Channel3.plotItem.getAxis("bottom").range[0]+self.ui.Channel3.plotItem.getAxis("bottom").range[1])/2
     center_y=0
     self.ui.Channel3.plotItem.getViewBox().scaleBy(y=0.9 ,x=0.9,center=(center_x,center_y))
    
    def zoomout1 (self):
       center_x=(self.ui.Channel1.plotItem.getAxis("bottom").range[0]+self.ui.Channel1.plotItem.getAxis("bottom").range[1])/2
       center_y=0
       self.ui.Channel1.plotItem.getViewBox().scaleBy(y=1/0.9 ,x=1/0.9,center=(center_x,center_y))
    def zoomout2 (self):
       center_x=(self.ui.Channel2.plotItem.getAxis("bottom").range[0]+self.ui.Channel2.plotItem.getAxis("bottom").range[1])/2
       center_y=0
       self.ui.Channel2.plotItem.getViewBox().scaleBy(y=1/0.9 ,x=1/0.9,center=(center_x,center_y))
    def zoomout3 (self):
       center_x=(self.ui.Channel3.plotItem.getAxis("bottom").range[0]+self.ui.Channel3.plotItem.getAxis("bottom").range[1])/2
       center_y=0
       self.ui.Channel3.plotItem.getViewBox().scaleBy(y=1/0.9 ,x=1/0.9,center=(center_x,center_y))


  #Scrolling Left,right
    def scroll_right1(self):
        self.ui.Channel1.plotItem.getViewBox().translateBy(x=-1000,y=0)
    ...
    def save_pdf (self):
            ...
            with pdf ("{}.pdf".format(pdf_name))as image:
                    ...
                    SP1 = self.data1.flatten()
                    Pxx, freqs, bins, im = ax2.specgram(SP1, NFFT=NFFT, Fs=Fs)
                    ...
                    fig, (ax2) = plt.subplots(nrows=1)
                    SP2 = self.data2.flatten()
                    Pxx, freqs, bins, im = ax2.specgram(SP2, NFFT=NFFT, Fs=Fs)
                    ...
                    SP3 = self.data3.flatten()
                    fig, (ax2) = plt.subplots(nrows=1)
                    Pxx, freqs, bins, im = ax2.specgram(SP3, NFFT=NFFT, Fs=Fs)
